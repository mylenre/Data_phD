...
os.chdir(r'R:\Modeling\Heat_Extraction_Paper\1D\Step_2_Flux_steady_state\SOLAR\SOLAR_Update_2200m2')
...
#t_y=eval(t_y)
t_y=1 # define in accordance to time sclae
t_d=dt_d*366*t_y
t_s=dt_s*366*t_y
...
##surface flux
plt.subplot(1,2,1)
amplitude = amp*np.sin(2*np.pi*(time/t_d*t_y))-0.064736 #0.01207 
