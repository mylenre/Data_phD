...
os.chdir(r'R:\GitHub\Data_phD\Data\CHESS_Midlothian_X334132_Y658017\CHESS_NearSurfaceAirTemp')
AT={}
alldate=[]
alltemp=[]
...
os.chdir(r'R:\GitHub\Data_phD\Data\CHESS_Midlothian_X334132_Y658017\CHESS_WindSpeed')
WS= {}
alldate=[]
allwind=[]
with open('listfile.txt', 'r') as filehandle:
...
os.chdir(r'R:\GitHub\Data_phD\Data\CHESS_Midlothian_X334132_Y658017\CHESS_SW_Radiations')
SW= {}
alldate=[]
allSW=[]
with open('listfile.txt', 'r') as filehandle:
...
os.chdir(r'R:\GitHub\Data_phD\Data\CHESS_Midlothian_X334132_Y658017\CHESS_LW_Radiations')
LW= {}
alldate=[]
allLW=[]
with open('listfile.txt', 'r') as filehandle:
...
os.chdir(r'R:\GitHub\Data_phD\Data\CHESS_Midlothian_X334132_Y658017')
...
plt.savefig('Midlothian_meteo.png') 
...
#plt.savefig('Midlothian_inputs.png') 

#np.savetxt('Curve_AT_Midlothian.txt', Curve_AT)
#np.savetxt('Curve_qcond_Midlothian.txt', Curve_qcond)