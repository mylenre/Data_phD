...
plt.axvline(x=20, ymin=0, ymax=0.55, linewidth=1, color='k', ls='--')
...
ax.set(xlabel="Distance along profile",
       ylabel="Temperature",
       title="Temperature along profile after 1 year of production")
plt.axis((0,200,0,16))
plt.legend(loc='best')
...
plt.title("Temperature differences along profile after 1 year production (2200m).")
plt.legend(loc='best')
